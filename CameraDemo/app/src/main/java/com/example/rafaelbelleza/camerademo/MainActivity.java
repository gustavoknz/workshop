...
public class MainActivity extends AppCompatActivity {
    ...
    public void cameraIntentClicked(View view) {
        Fragment currentFragment = getSupportFragmentManager()
                .findFragmentById(R.id.fragment_container);

        if (currentFragment instanceof CameraIntentFragment) {
            return;
        }
        ...
        transaction.replace(R.id.fragment_container, cameraIntentFragment);
    ...
    public void cameraCustomClicked(View view) {
        Fragment currentFragment = getSupportFragmentManager()
                .findFragmentById(R.id.fragment_container);
    ...
    public void callCameraApp(View view) {
        // create Intent to take a picture and return control to the calling application
        Intent cameraIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);

        fileUri = CameraCommon.getOutputMediaFileUri(CameraCommon.MEDIA_TYPE_IMAGE); // create a file to save the image
